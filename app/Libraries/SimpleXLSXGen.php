 ...
 * Migrated from CI3 SimpleXLSXGen.php library.
 * 
...
<sheets><sheet name="Sheet1" sheetId="1" state="visible" r:id="rId2"/></sheets>
    ...
    /**
     * Convert to string (generates XLSX file content)
     * 
     * @return string
     */
    ...
    /**
     * Download XLSX file with default filename
     * 
     * @return bool
     */
    ...
    /**
     * Download XLSX file with custom filename
     * 
     ...
     * @param int $day Day
     * @param int $hours Hours (default: 0)
     * @param int $minutes Minutes (default: 0)
